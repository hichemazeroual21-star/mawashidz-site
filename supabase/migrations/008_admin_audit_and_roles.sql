...
-- Requires: 005 (admin_set_profile_status + trigger bypass)
-- Creates public.user_roles if missing (fresh installs / incomplete baselines).
-- Idempotent. Does not change registration rows from the client.
-- ============================================================

-- 0) Platform elevation roles (membership type remains profiles.role)
...
-- No public INSERT/UPDATE/DELETE — grant/revoke via admin RPCs below (or service_role).
